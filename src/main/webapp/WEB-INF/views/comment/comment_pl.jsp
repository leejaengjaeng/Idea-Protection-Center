	...
	<div class="wrap_comment">
		...
		<div class="area_box a0" style="display: block;">
			<div class="plc"><div class="title_cmt"></div>
				...
				<div class="halfframe">
					<h1>발명가 의견</h1>
					<textarea class="half disabled pl before_cmt" placeholder="이전에 작성한 의견이 없습니다." disabled id="CurrentCommentTitle">${currentAnswer.getTitle()}</textarea>
				</div>
				<div class="titframe">
		...
		<div class="area_box a1">
			<div class="plc"><div class="title_cmt"></div>
				...
				<div class="halfframe">
					<h1>발명가 의견</h1>
					<textarea class="half disabled pl before_cmt" placeholder="이전에 작성한 의견이 없습니다." disabled id="CurrentCommentSummary">${currentAnswer.getSummary()}</textarea>
				</div>
				<div class="titframe">
					<h1>발명가 의견을 참고하여 내용을 작성해 주세요.</h1>
				</div>
		...
		<div class="area_box a2">
			<div class="plc"><div class="title_cmt"></div>
				...
				<div class="halfframe">
					<h1>발명가 의견</h1>
					<textarea class="half disabled pl before_cmt" placeholder="이전에 작성한 의견이 없습니다." disabled id="CurrentCommentWhyInvent">${currentAnswer.getWhyInvent()}</textarea>
				</div>
				<div class="titframe">
					<h1>발명가 의견을 참고하여 내용을 작성해 주세요.</h1>
				</div>
		...
		<div class="area_box a3">
			<div class="plc"><div class="title_cmt"></div>
				...
				<div class="halfframe">
					<h1>발명가 의견</h1>
					<textarea class="half disabled pl before_cmt" placeholder="이전에 작성한 의견이 없습니다." disabled id="CurrentCommentProblem">${currentAnswer.getProblem()}</textarea>
				</div>
				<div class="titframe">
					<h1>발명가 의견을 참고하여 내용을 작성해 주세요.</h1>
				</div>
		...
		<div class="area_box a4">
			<div class="plc"><div class="title_cmt"></div>
				...
				<div class="halfframe">
					<h1>발명가 의견</h1>
					<textarea  class="half disabled pl before_cmt" placeholder="이전에 작성한 의견이 없습니다." disabled id="CurrentCommentSolution">${currentAnswer.getSolution()}</textarea>
				</div>
				<div class="titframe">
					<h1>발명가 의견을 참고하여 내용을 작성해 주세요.</h1>
				</div>
		...
		<div class="area_box a5">
			<div class="plc"><div class="title_cmt"></div>
				...
				<div class="halfframe">
					<h1>발명가 의견</h1>
					<textarea  class="half disabled pl before_cmt" placeholder="이전에 작성한 의견이 없습니다." disabled id="CurrentCommentEffect">${currentAnswer.getEffect()}</textarea>
				</div>
				<div class="titframe">
					<h1>발명가 의견을 참고하여 내용을 작성해 주세요.</h1>
				</div>
		...
		<div class="area_box a6">
			<div class="plc"><div class="title_cmt"></div>
				...
				<div class="halfframe">
					<h1>발명가 의견</h1>
					<textarea class="half disabled pl before_cmt" placeholder="이전에 작성한 의견이 없습니다." disabled id="CurrentCommentCore_Element">${currentAnswer.getCore_element()}</textarea>
				</div>
				<div class="titframe">
					<h1>발명가 의견을 참고하여 내용을 작성해 주세요.</h1>
				</div>
		...
		<div class="area_box a7">
			<div class="plc"><div class="title_cmt"></div>
				...
				<div class="halfframe">
					<h1>발명가 의견</h1>
					<textarea class="half disabled pl before_cmt" placeholder="이전에 작성한 의견이 없습니다." disabled id="CurrentCommentHope_content()">${currentAnswer.getHope_content()}</textarea>
				</div>
				<div class="titframe">
					<h1>발명가 의견을 참고하여 내용을 작성해 주세요.</h1>
				</div>
		...
		<div class="area_box a9">
			<div class="plc"><div class="title_cmt"></div>
				...
				<div class="halfframe">
					<h1>발명가 의견</h1>
					<textarea class="half disabled pl before_cmt" placeholder="이전에 작성한 의견이 없습니다." disabled id="CurrentCommentPicture_explain">${currentAnswer.getPicture_explain()}</textarea>
				</div>
				<div class="titframe">
					<h1>발명가 의견을 참고하여 내용을 작성해 주세요.</h1>
				</div>
