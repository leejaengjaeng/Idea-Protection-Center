...
<footer>
    <div id="footer_benner">
        <div id="footer_benner_wrap">
            ...
            <img src="/resources/image/benner4.jpg" alt="benner4" onclick="location.href='http://www.rndip.re.kr/'">
    ...
    <div id="footer_fill">
        <div id="footer_wrap">
            <div id="footer_left">
                ...
                <ul>                        
                   <li><a href="/site_info">이용안내</a> &nbsp;| </li> 
                   <li><a href="/siteMap">오시는 길</a> &nbsp; </li> 
                </ul><br>
                <ul id="small_ul">                        
            ...
            <div id = "footer_right">
                <span>
                                   경기창조경제혁신센터 5층<br>
                                   경기도 성남시 분당구 대왕판교로 645번길 12<br>
                    Tel : 070-8825-5004<br>
                    mail : ideacontents@naver.com
                </span>
            </div>
        </div>            
    </div>
